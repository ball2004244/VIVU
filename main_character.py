...
class Player():
    ...
    def update(self):
        ...
        # CHECK LEFT BORDER
        if self.pos_x < self.game_surface_x + 100 and key_pressed[K_a]:
            self.theme_extend_left = True
        else:
            self.theme_extend_left = False

        # CHECK RIGHT BORDER
        if self.pos_x + self.surface_width > self.game_surface_x + self.game_surface_width - 100 and key_pressed[K_d]:
...
class StatusBar():
    ...
    def draw(self):
        ...
        Screen.blit(pygame.font.Font.render(
            FontType.FONT3, str(self.hp_amount) + '/' + str(self.max_hp), True, Colors.WHITE),
            (self.hp_x + 10, self.hp_y + self.hp_height / 2 - 3))
        ...
        Screen.blit(pygame.font.Font.render(
            FontType.FONT3, str(self.mp_amount) + '/' + str(self.max_mp), True, Colors.WHITE),
            (self.mp_x + 10, self.mp_y + self.mp_height / 2 - 3))
        pass
